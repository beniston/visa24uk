			...
			<div class="cbp-caption">
				...
				<div class="cbp-caption-activeWrap">
					<div class="cbp-l-caption-alignCenter">
						<div class="cbp-l-caption-body"> <a href="<?php print $node_url; ?>" class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow"><?php print t('more info'); ?></a> <a href="<?php print $img_full; ?>" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="<?php print $title; ?><br>by <?php print $author; ?>"><?php print t('view larger'); ?></a> </div>
					</div>
				</div>
			</div>
		</div>
