<?php
	if(arg(0) == 'user' && arg(1) == 'register') {
		$page_slogan = 'User Register Here...!';
	} elseif(arg(0) == 'user' && arg(1) == 'password') {
		$page_slogan = 'User reset your password...!';
	} else $page_slogan = 'User Login Here...!';
	...
	$page_header_class = theme_get_setting('page_default_page_header_class', 'probes');
?>
